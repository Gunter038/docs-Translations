...
Это руководство поможет в создании новой тестовой сети и поможет выполнить следующие правильные шаги для этого с помощью Celestia-App. You should only follow this guide if you want to experiment with your own Celestia Testnetwork or if you want to test out new features to build as a core developer.
